...
const state = {
  ...
  dragMode: '',                 // non-empty while dragging is in progress (canvas pan, panel resize, line handle drag)
...
const actions = {
   ...
   * Saves changes of an update-form and closes the form.
   *
   * @param   topic   a dmx.ViewTopic
   */
  update (_, topic) {
    ...
    delete topic.children['dmx.accesscontrol.username#linqa.reaction']      // don't create empty default-reaction
    //
